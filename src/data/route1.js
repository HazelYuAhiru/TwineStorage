export const route1 = [
  ...
  export const route1_1 = [
    {
      ...
      characters: { left: false, right: true }
    },
    {
      id: "r1s1-group2",
    ...
    },
    {
      ...
      characters: { left: true, right: true }
    },
    {
      id: "r1s1-group4",
    ...
    {
      id: "r1s1-group5",
      trigger: { text: "さかなもおきました", color: "#A3C4BC" },
      text: "おじいさんは、おもちとたくさんのたべものを買いました。そして、アンバーのために、さかなもおきました。",
      characters: { left: true, right: false }
    },
    {
      id: "r1s1-group6",
      trigger: { text: "しあわせなお正月", color: "#FFABAB" },
      text: "おじいさんとおばあさんは、しあわせなお正月をすごしました。",
      characters: { left: true, right: true }
    }
  ];
  ...
  export const route1_2 = [
    ...
    },
    {
      ...
      text: "ねこたちは小さい体で、いいざいりょうをあつめて、おじいさんとおばあさんがそのざいりょうで、すてきなかさを作りました。\nかさはとてもにんきで、たくさん売れました。\n人とねこが手をつなぎ、みんなでしあわせになりました。",
      characters: { left: true, right: true }
    }
  ];
  
  export const route1CastInfo = [
    { role: "ナレーション", name: "山田次郎" },
    { role: "脚本・演出", name: "制作チーム" },
    { role: "音楽", name: "作曲家" },
    { role: "グラフィック", name: "アーティスト" },
    { role: "", name: "温かい心で結ばれた物語でした" }
  ];